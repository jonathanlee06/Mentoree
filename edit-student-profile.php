                  ...
                  <div class="col-md-6">
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name = "edit_username" id="edit_username" class="form-control" placeholder="enter new username">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="row form-group ">
                      <div class="col-md-12 mb-3 mb-md-0">
                        ...
                        <input type="text" name = "edit_phone" id="edit_phone" class="form-control" placeholder="eg. 012345678">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="row form-group mb-5">
                      <div class="col-md-12 mb-3 mb-md-0">
                        ...
                        <input type="text" name = "edit_email" id="edit_email" class="form-control" placeholder="eg. person@email.com">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12">
                      <div class="row form-group ">
                        <div class="col-md-12 mb-3 mb-md-0">
                          ...
                          <input type="text" name = "edit_course" id="edit_course" class="form-control" placeholder="eg. Bachelor of Computer">
                        </div>
                      </div>
                  </div>
                </div>
